        ...
        <div className="container">
          <article>
            <div className="footer-icon">
              <img src="/images/white-logo.png" alt="white logo metabnb" />
              ...
              <div className="icons flex">
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_6082_595)">
                    <path
          ...
          <div className="copywrite">
            <img src="/images/ri_copyright-line.png" alt="white logo metabnb" />
            <p> 2022 Metabnb</p>
          </div>
        </div>
      </footer>
